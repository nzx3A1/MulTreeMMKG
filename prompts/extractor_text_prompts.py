...
def ENTITY_PROMPT_noSchema( text: str, context: Any = None,) -> dict[str, Any]:
     ...
     return {
        ...
        "task": "只根据 text 抽取实体，输出可映射到 model.graph.Entity 的 JSON 对象。",
        ...
        "example": {
            "input": "鄂尔多斯盆地延长组长7段主要发育暗色泥岩，TOC为2.1%~6.5%。",
            "output": {"entities": [
                {
                    "name": "鄂尔多斯盆地",
                    ...
                    "type_zh": "盆地",
                    "attributes": {},
                    "provenance": "鄂尔多斯盆地延长组长7段主要发育暗色泥岩",
...
def RELATION_PROMPT_noSchema(
    ...
    return {
        ...
        "example": {
            "entity_list": [
                {"id": "entity_1", "name": "延长组长7段", "type_zh": "段"},
                {"id": "entity_2", "name": "鄂尔多斯盆地", "type_zh": "盆地"},
            ],
            "input": evidence,
            "output": {"relations": [
                {
